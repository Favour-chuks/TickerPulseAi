      ...
      <div className="w-full max-w-md z-10 animate-in fade-in zoom-in-95 duration-500">
        <div className="bg-white/80 dark:bg-[#121214] border border-white/50 dark:border-[#212124] p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-2xl backdrop-blur-xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight mb-1">TickerPulse</h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Institutional Narrative Intelligence</p>
          </div>
          ...
          {view === 'forgot' && resetSent ? (
            <div className="text-center space-y-6 py-4">
              ...
              <div className="space-y-2">
                <h3 className="text-slate-900 dark:text-white font-bold text-xl">Reset Link Sent</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">Check your inbox at <span className="font-bold text-slate-900 dark:text-white">{email}</span> for instructions.</p>
              </div>
              <button 
            ...
            <>
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest">
                  <span className="bg-white dark:bg-[#121214] px-3 text-slate-400">Or continue with</span>
                </div>
              </div>
          ...
          <div className="mt-8 text-center border-t border-slate-100 dark:border-[#212124] pt-6">
            {view === 'login' ? (
              <p className="text-sm text-slate-500">
                ...
                <button onClick={() => setView('register')} className="font-bold text-brand-600 dark:text-brand-400 hover:underline">
                  Register
                </button>
              </p>
            ) : view === 'register' ? (
              <p className="text-sm text-slate-500">
                ...
                <button onClick={() => setView('login')} className="font-bold text-brand-600 dark:text-brand-400 hover:underline">
                  Login
                </button>
              </p>
            ) : (
