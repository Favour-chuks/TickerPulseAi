...
import { X, HelpCircle, Zap, AlertTriangle, Activity, BarChart2, BookOpen, Navigation, ShieldAlert, MessageSquareText, List, CheckCircle2, TrendingUp, Search, Target } from 'lucide-react';
