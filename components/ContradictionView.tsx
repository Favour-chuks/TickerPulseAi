...
const ContradictionCard: React.FC<{ data: Contradiction }> = ({ data }) => {
  ...
  return (
    <div className={`bg-white dark:bg-[#121214] border rounded-2xl overflow-hidden flex flex-col transition-all duration-300 shadow-sm hover:shadow-lg dark:shadow-black/20 ${
      validated 
        ? 'border-emerald-500/30' 
        : 'border-slate-200 dark:border-[#212124] hover:border-rose-300 dark:hover:border-rose-500/30'
    }`}>
       {/* Card Header - Always Visible */}
       <div className="p-6 border-b border-slate-100 dark:border-[#212124] flex items-center justify-between bg-slate-50 dark:bg-[#1c1c1f]/50 cursor-pointer" onClick={() => setExpanded(!expanded)}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
                {data.tickerSymbol} 
                <span className="text-slate-400 dark:text-slate-500 font-light text-sm">//</span> 
       ...
       <div className="p-6 pb-0 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-[#0a0a0b] border border-slate-200 dark:border-[#212124] relative min-h-[100px]">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-[#0a0a0b] border border-rose-200 dark:border-rose-500/20 relative min-h-[100px]">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:flex hidden z-10">
              <div className="w-8 h-8 rounded-full bg-rose-500 flex items-center justify-center text-white dark:text-black border-4 border-white dark:border-[#121214]">
       ...
       >
          <div className="pt-6 border-t border-slate-100 dark:border-[#212124] grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 pb-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-[#0a0a0b] rounded-lg">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                 <div className="p-2 bg-slate-50 dark:bg-[#0a0a0b] rounded-lg">
       ...
       <div className="p-6 bg-slate-50 dark:bg-[#0a0a0b] border-t border-slate-100 dark:border-[#212124] flex items-center justify-between mt-auto">
          ...
          <div className="flex gap-3">
            <button className="px-4 py-2 bg-white dark:bg-[#1c1c1f] border border-slate-200 dark:border-[#2d2d31] rounded-lg text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-[#252529] transition-all">
              Investigate
            </button>
            {!validated && (
              <button 
                onClick={handleValidate}
                className="px-4 py-2 bg-slate-900 dark:bg-white text-white dark:text-black rounded-lg text-xs font-bold hover:opacity-90 transition-all flex items-center gap-2"
              >
...
const ContradictionView: React.FC = () => {
  return (
    <div className="space-y-8 animate-in zoom-in-95 duration-500 pb-12">
      <div className="bg-rose-50 dark:bg-rose-500/10 border border-rose-200 dark:border-rose-500/20 p-8 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="hidden lg:flex items-center gap-2 bg-white dark:bg-[#1c1c1f] p-4 rounded-xl border border-slate-200 dark:border-[#2d2d31]">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        {MOCK_CONTRADICTIONS.map((c) => (
          <ContradictionCard key={c.id} data={c} />
        ))}
      </div>
    </div>
  );
